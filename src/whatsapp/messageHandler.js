...
import { isOwner, isGroupAdmin, normalizeJid } from '../commands/permissions.js';
import { commands } from '../commands/handler.js';
import { checkMessage, VIOLATION_LABELS } from '../features/moderationEngine.js';
import { handleDm, handleOwnerDmExtra } from '../dm/dmHandler.js';
...
function extractText(msg) {
  ...
  // respons dari tombol native flow (quick_reply / list "Pilih Menu" / cta_url) --
  // id yang kita set sengaja berisi command teks aslinya, jadi tetap kepakai parser biasa
  ...
  if (nativeFlow) {
    try {
      ...
      // lanjut ke fallback biasa di bawah
    }
  }
